...
public class StatusBar {
	 ...
	 * @param bounds        Contains width / height
	 * @param barColor      Color of bar if changeColors is false
	 * @param changeColors  Enable the bar to automatically change colors based on value
	 * @param isVertical    Enable if the bar is a vertically read status bar
	 * @param labelPosition Determines where the label is placed: TOP, MIDDLE, or BOTTOM
	 * @param label         Label of the status bar
	 * @param showLimits    Display the limits of the status bar on the respective ends
	 * @param min           Minimum value of the status bar
	 * @param max           Maximum value of the status bar
	 * @param value         Preset current value for status bar to display
	 */
