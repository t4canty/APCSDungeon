...
public class AnimatedImage {
	 ...
	 * Source spritesheet to use.
	 * @param onlyRunOnce
	 * Sets whether or not the animation should repeat.
	 */
	...
	public Image getNextFrame() {
		if(isStatic) return (Image) spritesheet;
		...
		Image tmp = null;
		try {tmp = (Image) spritesheet.getSubimage(0, frameY, spritesheet.getWidth(), spritesheet.getWidth());}
		catch(RasterFormatException e) {e.printStackTrace(); tmp = (Image) ImageLoader.NO_IMAGE;}
		return tmp;
	}
	/**
